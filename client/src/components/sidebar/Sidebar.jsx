...
const Sidebar = ({ isOpen, onClose }) => {
  ...
  return (
    <aside className={`sidebar ${isOpen ? 'sidebar-open' : ''}`}>
      ...
      <div className="sidebar-section">
        <p className="section-title">Recruitment</p>
        <NavLink to="/dashboard/candidates" onClick={handleNavLinkClick}>
      ...
      <div className="sidebar-section">
        <p className="section-title">Organization</p>
        <NavLink to="/dashboard/employees" onClick={handleNavLinkClick}>
          <MdOutlineGroup /> Employees
        </NavLink>
        <NavLink to="/dashboard/attendance" onClick={handleNavLinkClick}>
          <MdOutlineCalendarToday /> Attendance
        </NavLink>
        <NavLink to="/dashboard/leaves" onClick={handleNavLinkClick}>
          <MdOutlineAccessTime /> Leaves
        </NavLink>
      </div>
